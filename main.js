...
function displayData(data) {
  ...
  document.querySelector('#address').innerText = data.location.region + ',' + data.location.country
  document.querySelector('#timezone').innerText = 'UTC' + data.location.timezone
